...
public class BlockParentHandler_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.puppycrawl.tools.checkstyle.api.DetailAST", false, BlockParentHandler_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.puppycrawl.tools.checkstyle.checks.indentation.AbstractExpressionHandler", false, BlockParentHandler_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.puppycrawl.tools.checkstyle.checks.indentation.IndentationCheck", false, BlockParentHandler_ESTest_scaffolding.class.getClassLoader()));
  }
